...
CREATE TABLE public.urls (
    ...
    url text NOT NULL,
    title text NOT NULL,
    description_url character varying(255) NOT NULL,
    image text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
);
...
--
-- Name: posthashtags posthashtags_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posthashtags
    ADD CONSTRAINT posthashtags_pkey PRIMARY KEY (id);
...
--
-- Name: posthashtags posthashtags_hastag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posthashtags
    ADD CONSTRAINT posthashtags_hastag_id_fkey FOREIGN KEY (hastag_id) REFERENCES public.hashtags(id);


--
-- Name: posthashtags posthashtags_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posthashtags
    ADD CONSTRAINT posthashtags_post_id_fkey FOREIGN KEY (post_id) REFERENCES public.posts(id);


--
-- Name: posts posts_url_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
